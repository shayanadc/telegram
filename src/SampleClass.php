...
//    echo $n->removeKeyboardMessage(28737977,'byby');
    return $n->sendPhoto(28737977,'phpoto', 'http://keenthemes.com/preview/metronic/theme/assets/global/plugins/jcrop/demos/demo_files/image1.jpg', ['reply_markup' => $n->forceReply()]);

//    return $n->sendKeyboardButton(28737977,'gaga',[['text' => ['gha']]]);
//    return $n->sendForceReply(28737977,'gaga');
//    return $n->getMe();
//    return $n->exeCURL();
